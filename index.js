...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nestedFunction can access internal because internal is in the same function (myFunction).
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopulationCount = [];
    array.filter(function(item){
      if(item.population <= 5){
        lowPopulationCount.push(item);
      }
    });
...
CuboidMaker.prototype.volume = function(atr){
...
/* 🐴🐴🐴 Step 3: Surface Area Method 🐴🐴🐴
  ...
  CuboidMaker.prototype.surfaceArea = function(atr){
